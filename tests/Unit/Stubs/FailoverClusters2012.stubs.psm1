<#
    ...
    .NOTES
        Generated from module FailoverClusters (version 1.0.0.0), on
        operating system Microsoft Windows Server 2012 Standard Evaluation 64-bit (6.2.9200)
#>
...
function Add-ClusterPrintServerRole {
    [CmdletBinding(DefaultParameterSetName='InputObject', HelpUri='http://go.microsoft.com/fwlink/?LinkId=216191')]
    param(
        [ValidateNotNullOrEmpty()]
        [System.Collections.Specialized.StringCollection]
        ${Storage},
...
function Repair-ClusterSharedVolume {
    [CmdletBinding(DefaultParameterSetName='ChkDsk', HelpUri='http://go.microsoft.com/fwlink/?LinkId=216242')]
    param(
        [Parameter(Mandatory=$true, Position=0)]
        [ValidateNotNullOrEmpty()]
        [string]
        ...
        [Parameter(ParameterSetName='ChkDsk', Mandatory=$true)]
        [switch]
        ${ChkDsk},

        [Parameter(ParameterSetName='Defrag', Mandatory=$true)]
        [switch]
        ${Defrag},
...
function Start-ClusterNode {
    ...
    param(
        ...
        [Parameter(HelpMessage='Specifies if the cluster is in a fix quorum state.')]
        [Alias('fq')]
        [switch]
        ${FixQuorum},
